 ...
 *
 * This template can be overridden by copying it to ecademy/learnpress/settings/tabs/avatar.php.
 *
 * @author   EnvyTheme
...
<form name="profile-avatar" method="post" enctype="multipart/form-data">
    ...
    <div id="lp-user-edit-avatar" class="lp-edit-profile lp-edit-avatar">
        <div class="lp-avatar-preview"
             style="width: <?php echo esc_attr( $thumb_size['width'] ); ?>px;height: <?php echo esc_attr( $thumb_size['height'] ); ?>px;">
            <div class="profile-picture profile-avatar-current">
				<?php if ( $custom_img ) { ?>
                    <img src="<?php echo esc_url( $custom_img ); ?>"/>
				<?php } else { ?>
					<?php echo wp_kses_post( $gravatar_img ); ?>
				<?php } ?>
            </div>
			<?php if ( $custom_img ) { ?>
        ...
        <p id="lp-avatar-actions">
            <button id="lp-upload-photo" type="button"><?php esc_html_e( 'Upload', 'ecademy' ); ?></button>
			<?php if ( $custom_img != '' ): ?>
                <button id="lp-remove-upload-photo"><?php esc_html_e( 'Remove', 'ecademy' ); ?></button>
			<?php endif; ?>
        </p>
    </div>
    ...
    <button type="submit" id="submit" name="submit"><?php esc_html_e( 'Save changes', 'ecademy' ); ?></button>
