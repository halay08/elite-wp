 ...
 *
 * This template can be overridden by copying it to ecademy/learnpress/single-course/tabs/curriculum.php.
 *
 * @author  EnvyTheme
...
<div class="courses-curriculum" id="learn-press-course-curriculum">
    ...
    <div class="curriculum-scrollable">
		...
		<?php } else { ?>
			...
			<?php echo apply_filters( 'learn_press_course_curriculum_empty', __( 'Curriculum is empty', 'ecademy' ) ); ?>
