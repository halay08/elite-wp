    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(83, 83, 83);">
        <div style="width:500px; max-width:calc(90% - 40px); margin: 25px auto; background: rgb(231, 231, 231); border-radius: 20px; padding: 40px;">
            <div style="background:white; padding: 30px; border-radius: 20px; text-align: center;">
                <img src="<?php echo TUTOR_GC()->url; ?>assets/images/mail-icon.png" style="display:inline-block"/>
                <br/>
                <br/>
                <h3 style="margin: 0;">
                    <?php echo __('Please, Verify Your Email Address', 'tutor-pro'); ?>
                </h3>
                <br/>
                ...
                <p style="margin: 0;">
                    <?php 
                        ...
                        $domain_anchor = '<a href="'.$site_url.'" target="_blank" style="text-decoration: none;">'.parse_url($site_url)['host'].'</a>';
                ...
                <br/>
                <br/>
                <a href="<?php echo $password_reset_link; ?>" target="_blank" style="background: #3E64DE; color: white; border-radius: 3px; padding: 10px 50px; text-decoration: none;">Verify Email</a>
                <br/>
                <br/>
            </div>
        </div>
